  ...
  template: `
    ...
    <div class="admin-sidebar">
      <div class="p-4 border-bottom border-secondary">
        <a routerLink="/admin" class="text-white text-decoration-none d-flex align-items-center">
      ...
      <div class="position-absolute bottom-0 w-100 p-3 border-top border-secondary">
        <div class="d-flex align-items-center mb-3 px-2">
          ...
          <div>
            <div class="text-white small fw-semibold">{{ authService.user()?.name }}</div>
        ...
        <button class="sidebar-link w-100 border-0 bg-transparent text-start" (click)="logout()">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
